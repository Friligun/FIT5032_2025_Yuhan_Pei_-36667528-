...
/**
 * Confirm password validation function that checks if the password and confirm password match.
 * @param blur: boolean - If true, the function will display an error message if they don't match.
 */
